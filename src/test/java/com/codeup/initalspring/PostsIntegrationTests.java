...
@SpringBootTest(classes = InitalspringApplication.class)
...
public class PostsIntegrationTests {
    ...
    public void testAdsIndex() throws Exception {
        ...
        // Makes a Get request to /posts and verifies that we get some of the static text of the posts/index.html template and at least the title from the first Post present in the template.
